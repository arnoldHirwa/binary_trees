...
/**
 * balance_tree - balance an AVL tree
 * @tree: pointer to the root node of the tree to balance_tree
 * @node: pointer to the node to be inserted
 * Return: pointer to the new root node of the tree once balance_treed
 */
avl_t *balance_tree(avl_t *tree, avl_t *node)
{
	int balance_factor;
